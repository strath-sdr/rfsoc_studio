-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\axis_packet_generator\AxisPacketGenerator_fifo_data_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: AxisPacketGenerator_fifo_data_block
-- Source Path: AxisPacketGenerator/AxisPacketGenerator_axi4_stream_imag_slave/AxisPacketGenerator_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY AxisPacketGenerator_fifo_data_block IS
...
END AxisPacketGenerator_fifo_data_block;


ARCHITECTURE rtl OF AxisPacketGenerator_fifo_data_block IS
...
BEGIN
  ...
  u_AxisPacketGenerator_fifo_data_classic_ram : AxisPacketGenerator_SimpleDualPortRAM_generic
