-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\axis_packet_generator\AxisPacketGenerator_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: AxisPacketGenerator_addr_decoder
-- Source Path: AxisPacketGenerator/AxisPacketGenerator_axi_lite/AxisPacketGenerator_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY AxisPacketGenerator_addr_decoder IS
...
END AxisPacketGenerator_addr_decoder;


ARCHITECTURE rtl OF AxisPacketGenerator_addr_decoder IS

  -- Signals
  SIGNAL enb                              : std_logic;
  SIGNAL addr_sel_unsigned                : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL decode_sel_transfer_1_1          : std_logic;  -- ufix1
  ...
  SIGNAL reg_enb_transfer_1_1             : std_logic;  -- ufix1
  SIGNAL data_reg_transfer_1_1            : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_transfer_1_1           : unsigned(31 DOWNTO 0);  -- ufix32

BEGIN
  addr_sel_unsigned <= unsigned(addr_sel);

  
  decode_sel_transfer_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0041#, 14) ELSE
      '0';
  ...
  reg_enb_transfer_1_1 <= decode_sel_transfer_1_1 AND wr_enb;

  reg_transfer_1_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      data_reg_transfer_1_1 <= to_unsigned(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' AND reg_enb_transfer_1_1 = '1' THEN
        data_reg_transfer_1_1 <= data_write_unsigned;
      END IF;
    END IF;
  END PROCESS reg_transfer_1_1_process;


  
  decode_rd_transfer_1_1 <= decode_rd_packet_size_1_1 WHEN decode_sel_transfer_1_1 = '0' ELSE
      data_reg_transfer_1_1;

  data_read <= std_logic_vector(decode_rd_transfer_1_1);

  write_axi_enable <= write_concats_axi_enable_1;

  write_packet_size <= std_logic_vector(data_reg_packet_size_1_1);

  write_transfer <= std_logic_vector(data_reg_transfer_1_1);
