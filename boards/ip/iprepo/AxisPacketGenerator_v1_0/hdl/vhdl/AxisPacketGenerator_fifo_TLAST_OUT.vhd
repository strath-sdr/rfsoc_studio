-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\axis_packet_generator\AxisPacketGenerator_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: AxisPacketGenerator_fifo_TLAST_OUT
-- Source Path: AxisPacketGenerator/AxisPacketGenerator_axi4_stream_real_master/AxisPacketGenerator_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY AxisPacketGenerator_fifo_TLAST_OUT IS
...
END AxisPacketGenerator_fifo_TLAST_OUT;


ARCHITECTURE rtl OF AxisPacketGenerator_fifo_TLAST_OUT IS
...
BEGIN
  ...
  u_AxisPacketGenerator_fifo_TLAST_OUT_classic_ram_singlebit : AxisPacketGenerator_SimpleDualPortRAM_singlebit
