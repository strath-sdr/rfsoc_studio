-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\axis_packet_generator\AxisPacketGenerator_fifo_TLAST_OUT_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: AxisPacketGenerator_fifo_TLAST_OUT_block
-- Source Path: AxisPacketGenerator/AxisPacketGenerator_axi4_stream_imag_master/AxisPacketGenerator_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY AxisPacketGenerator_fifo_TLAST_OUT_block IS
...
END AxisPacketGenerator_fifo_TLAST_OUT_block;


ARCHITECTURE rtl OF AxisPacketGenerator_fifo_TLAST_OUT_block IS

  -- Component Declarations
  COMPONENT AxisPacketGenerator_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : AxisPacketGenerator_SimpleDualPortRAM_singlebit
    USE ENTITY work.AxisPacketGenerator_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_AxisPacketGenerator_fifo_TLAST_OUT_classic_ram : AxisPacketGenerator_SimpleDualPortRAM_singlebit
