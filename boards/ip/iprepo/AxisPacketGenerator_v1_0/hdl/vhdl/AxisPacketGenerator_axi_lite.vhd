-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\axis_packet_generator\AxisPacketGenerator_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: AxisPacketGenerator_axi_lite
-- Source Path: AxisPacketGenerator/AxisPacketGenerator_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY AxisPacketGenerator_axi_lite IS
...
END AxisPacketGenerator_axi_lite;


ARCHITECTURE rtl OF AxisPacketGenerator_axi_lite IS

  -- Component Declarations
  COMPONENT AxisPacketGenerator_addr_decoder
  ...
  COMPONENT AxisPacketGenerator_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : AxisPacketGenerator_addr_decoder
    USE ENTITY work.AxisPacketGenerator_addr_decoder(rtl);

  FOR ALL : AxisPacketGenerator_axi_lite_module
    USE ENTITY work.AxisPacketGenerator_axi_lite_module(rtl);
  ...
  SIGNAL write_transfer_tmp               : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_AxisPacketGenerator_addr_decoder_inst : AxisPacketGenerator_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              write_transfer => write_transfer_tmp  -- ufix32
              );

  u_AxisPacketGenerator_axi_lite_module_inst : AxisPacketGenerator_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_transfer <= write_transfer_tmp;
