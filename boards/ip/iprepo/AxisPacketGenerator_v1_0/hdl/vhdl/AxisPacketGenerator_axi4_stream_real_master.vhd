-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\axis_packet_generator\AxisPacketGenerator_axi4_stream_real_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: AxisPacketGenerator_axi4_stream_real_master
-- Source Path: AxisPacketGenerator/AxisPacketGenerator_axi4_stream_real_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY AxisPacketGenerator_axi4_stream_real_master IS
...
END AxisPacketGenerator_axi4_stream_real_master;


ARCHITECTURE rtl OF AxisPacketGenerator_axi4_stream_real_master IS

  -- Component Declarations
  COMPONENT AxisPacketGenerator_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT AxisPacketGenerator_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : AxisPacketGenerator_fifo_data_OUT
    USE ENTITY work.AxisPacketGenerator_fifo_data_OUT(rtl);

  FOR ALL : AxisPacketGenerator_fifo_TLAST_OUT
    USE ENTITY work.AxisPacketGenerator_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_AxisPacketGenerator_fifo_data_OUT_inst : AxisPacketGenerator_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              ...
              Out_rsvd => AXI4_Stream_Real_Master_TDATA_tmp,  -- ufix128
              Empty => fifo_empty_data,  -- ufix1
              AFull => fifo_afull_data  -- ufix1
              );

  u_AxisPacketGenerator_fifo_TLAST_OUT_inst : AxisPacketGenerator_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
