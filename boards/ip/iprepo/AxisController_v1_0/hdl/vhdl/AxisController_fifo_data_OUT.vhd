-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\axis_controller\AxisController_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: AxisController_fifo_data_OUT
-- Source Path: AxisController/AxisController_axi4_stream_master/AxisController_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY AxisController_fifo_data_OUT IS
...
END AxisController_fifo_data_OUT;


ARCHITECTURE rtl OF AxisController_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT AxisController_SimpleDualPortRAM_generic
  ...
  FOR ALL : AxisController_SimpleDualPortRAM_generic
    USE ENTITY work.AxisController_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_AxisController_fifo_data_OUT_classic_ram_generic : AxisController_SimpleDualPortRAM_generic
