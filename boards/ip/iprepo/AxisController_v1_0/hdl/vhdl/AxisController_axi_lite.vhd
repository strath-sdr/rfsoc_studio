-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\axis_controller\AxisController_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: AxisController_axi_lite
-- Source Path: AxisController/AxisController_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY AxisController_axi_lite IS
...
END AxisController_axi_lite;


ARCHITECTURE rtl OF AxisController_axi_lite IS

  -- Component Declarations
  COMPONENT AxisController_addr_decoder
  ...
  COMPONENT AxisController_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : AxisController_addr_decoder
    USE ENTITY work.AxisController_addr_decoder(rtl);

  FOR ALL : AxisController_axi_lite_module
    USE ENTITY work.AxisController_axi_lite_module(rtl);
...
BEGIN
  u_AxisController_addr_decoder_inst : AxisController_addr_decoder
  ...
  u_AxisController_axi_lite_module_inst : AxisController_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
