-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\axis_controller\AxisController_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: AxisController_fifo_TLAST_OUT
-- Source Path: AxisController/AxisController_axi4_stream_master/AxisController_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY AxisController_fifo_TLAST_OUT IS
...
END AxisController_fifo_TLAST_OUT;


ARCHITECTURE rtl OF AxisController_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT AxisController_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : AxisController_SimpleDualPortRAM_singlebit
    USE ENTITY work.AxisController_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_AxisController_fifo_TLAST_OUT_classic_ram_singlebit : AxisController_SimpleDualPortRAM_singlebit
